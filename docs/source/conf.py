...
project = 'qtsit'
copyright = '2022, qtsit-contributors'
author = 'qtsit-contributors'

# The full version, including alpha/beta/rc tags
version = qtsit.__version__
release = qtsit.__version__
...
def linkcode_resolve(domain, info):
    ...
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(qtsit.__file__))
    ...
    if domain != 'py' or not info['module']:
        return None
    try:
        filename = 'qtsit/%s#L%d-L%d' % find_source()
    except Exception:
